...
namespace Bevolking.Proxies
{
    ...
    public partial class BewoningClient
    {
        ...
        public BewoningClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <param name="burgerservicenummer">Met het burgerservicenummer als parameter wordt de bewoning waar deze persoon op peildatum of in de gevraagde periode verblijft of verbleven is opgehaald met alle bijbehorende bewoners per bewoning.</param>
        /// <param name="identificatiecodenummeraanduiding">De unieke aanduiding van een NUMMERAANDUIDING.</param>
        /// <returns>Zoekactie geslaagd</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<BewoningHalCollectie> GetBewoningenAsync(string expand, string fields, System.DateTimeOffset? peildatum, System.DateTimeOffset? datumvan, System.DateTimeOffset? datumtotenmet, string burgerservicenummer, string identificatiecodenummeraanduiding)
        {
            return GetBewoningenAsync(expand, fields, peildatum, datumvan, datumtotenmet, burgerservicenummer, identificatiecodenummeraanduiding, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Zoekactie geslaagd</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<BewoningHalCollectie> GetBewoningenAsync(string expand, string fields, System.DateTimeOffset? peildatum, System.DateTimeOffset? datumvan, System.DateTimeOffset? datumtotenmet, string burgerservicenummer, string identificatiecodenummeraanduiding, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/bewoningen?");
            if (expand != null)
            {
        ...
        /// <returns>Zoekactie geslaagd</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<BewoningHal> GetBewoningAsync(string expand, string fields, System.DateTimeOffset? peildatum, System.DateTimeOffset? datumvan, System.DateTimeOffset? datumtotenmet, string identificatiecodenummeraanduiding)
        {
            return GetBewoningAsync(expand, fields, peildatum, datumvan, datumtotenmet, identificatiecodenummeraanduiding, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Zoekactie geslaagd</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<BewoningHal> GetBewoningAsync(string expand, string fields, System.DateTimeOffset? peildatum, System.DateTimeOffset? datumvan, System.DateTimeOffset? datumtotenmet, string identificatiecodenummeraanduiding, System.Threading.CancellationToken cancellationToken)
        {
            if (identificatiecodenummeraanduiding == null)
                throw new System.ArgumentNullException("identificatiecodenummeraanduiding");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/bewoningen/{identificatiecodenummeraanduiding}?");
        ...
        /// <returns>Zoekactie geslaagd</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Verloop> GetBewoningverloopAsync(string fields, System.DateTimeOffset? datumvan, System.DateTimeOffset? datumtotenmet, string identificatiecodenummeraanduiding)
        {
            return GetBewoningverloopAsync(fields, datumvan, datumtotenmet, identificatiecodenummeraanduiding, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Zoekactie geslaagd</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Verloop> GetBewoningverloopAsync(string fields, System.DateTimeOffset? datumvan, System.DateTimeOffset? datumtotenmet, string identificatiecodenummeraanduiding, System.Threading.CancellationToken cancellationToken)
        {
            if (identificatiecodenummeraanduiding == null)
                throw new System.ArgumentNullException("identificatiecodenummeraanduiding");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/bewoningen/{identificatiecodenummeraanduiding}/verloop?");
            urlBuilder_.Replace("{identificatiecodenummeraanduiding}", System.Uri.EscapeDataString(ConvertToString(identificatiecodenummeraanduiding, System.Globalization.CultureInfo.InvariantCulture)));
            if (fields != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("fields") + "=").Append(System.Uri.EscapeDataString(ConvertToString(fields, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
    ...
    public partial class Bewoning
    {
        ...
        /// <summary>&lt;body&gt;Een door of namens het bevoegd gemeentelijk orgaan ten aanzien van een adresseerbaar object toegekende toevoeging aan een huisnummer in de vorm van een alfanumeriek teken.&lt;/body&gt;</summary>
        ...
        /// <summary>&lt;body&gt;Een door of namens het bevoegd gemeentelijk orgaan ten aanzien van een adresseerbaar object toegekende nummering.&lt;/body&gt;</summary>
        ...
        /// <summary>&lt;body&gt;Een door of namens het bevoegd gemeentelijk orgaan ten aanzien van een adresseerbaar object toegekende nadere toevoeging aan een huisnummer of een combinatie van huisnummer en huisletter.&lt;/body&gt;</summary>
        ...
        /// <summary>De unieke aanduiding van een NUMMERAANDUIDING.</summary>
        ...
        /// <summary>&lt;body&gt;Een door het bevoegde gemeentelijke orgaan aan een OPENBARE RUIMTE toegekende benaming&lt;/body&gt;</summary>
        ...
        /// <summary>&lt;body&gt;De door PostNL vastgestelde code behorende bij een bepaalde combinatie van een naam van een woonplaats, naam van een openbare ruimte en een huisnummer&lt;/body&gt;</summary>
        ...
        /// <summary>De unieke identificatie van een VERBLIJFSOBJECT.</summary>
        ...
        /// <summary>&lt;body&gt;De door het bevoegde gemeentelijke orgaan aan een WOONPLAATS toegekende benaming.&lt;/body&gt;&lt;body&gt;Zie verder de toelichting in de BAG.&lt;/body&gt;</summary>
    ...
    public partial class BewoningHal : Bewoning
    {
        ...
        public Bewoning_embedded _embedded { get; set; }
    ...
    ///  &lt;em&gt;*&lt;/em&gt; datumVan** : Datum waarop de bewoner op dit adres is ingeschreven.&lt;/p&gt;&lt;p&gt;
    ///  &lt;em&gt;*&lt;/em&gt; datumEindeTotenMet** : Datum waarop de bewoner bij dit adres is uitgeschreven.&lt;/p&gt;&lt;/body&gt;</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.11.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class Bewoner
    {
        ...
        /// <summary>Een aanduiding die aangeeft dat gegevens van de verblijfplaats van deze bewoner in onderzoek zijn. Indien true: verblijfplaats is in onderzoek.</summary>
        [Newtonsoft.Json.JsonProperty("indicatieVerblijfsplaatsInOnderzoek", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        /// <summary>&lt;body&gt;&lt;p&gt;Het aantal keren dat een alleenstaande of gezin naar het adres is verhuisd binnen de opgegeven periode&lt;/p&gt;&lt;/body&gt;</summary>
        ...
        /// <summary>&lt;body&gt;&lt;p&gt;Het aantal keer dat een alleenstaande of gezin van het adres naar een ander adres is verhuisd binnen de opgegeven periode&lt;/p&gt;&lt;/body&gt;</summary>
        ...
        /// <summary>Gemiddeld aantal bewoners in de gevraagde periode.</summary>
        [Newtonsoft.Json.JsonProperty("gemiddeldAantalBewoners", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        /// <summary>De ingeschreven natuurlijk personen die bewoner zijn of waren.</summary>
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.11.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class Bewoning_embedded
    {
        [Newtonsoft.Json.JsonProperty("ingeschrevenPersonen", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<IngeschrevenPersonen> IngeschrevenPersonen { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.11.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class IngeschrevenPersonen : IngeschrevenPersoon
    {
        [Newtonsoft.Json.JsonProperty("_links", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
